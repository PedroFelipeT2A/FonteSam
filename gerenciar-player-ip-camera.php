...
<video id="player_webtv" class="video-js vjs-big-play-centered" <?php echo $_POST["autoplay"]; ?> controls preload="auto" width="<?php echo $_POST["largura"]; ?>" height="<?php echo $_POST["altura"]; ?>" data-setup="{ 'fluid':true,'aspectRatio':'<?php echo $_POST["aspectratio"]; ?>' }" <?php if($_POST["capa"] && $_POST["capa"] != "http://") { echo 'poster="'.$_POST["capa"].'"'; } ?>>
   <source src="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" type="application/x-mpegURL">
</video>
...
<script>var myPlayer=videojs('player_webtv',{},function(){var player=this;player.on("pause",function(){player.one("play",function(){player.load();player.play();});});})</script></textarea>
          ...
          <tr>
            <td width="230" align="center" valign="top" class="texto_padrao"><a href="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8"><img src="http://<?php echo $url_player; ?>/img/icones/img-icone-player-android.png" width="32" height="32" border="0" /></a><br />
                <br />
                <textarea readonly="readonly" style="width:220px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8"><img src="http://<?php echo $url_player; ?>/img/icones/img-icone-player-iphone.png" width="32" height="32" title="Ouvir no iphone" /></a></textarea>
                <br /></td>
            <td width="230" align="center" class="texto_padrao"><a href="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8"><img src="http://<?php echo $url_player; ?>/img/icones/img-icone-player-blackberry.png" width="32" height="32" border="0" /></a><br />
                <br />
                <textarea readonly="readonly" style="width:220px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8"><img src="http://<?php echo $url_player; ?>/img/icones/img-icone-player-iphone.png" width="32" height="32" title="Ouvir no iphone" /></a></textarea>
                <br /></td>
            <td width="230" align="center" valign="top" class="texto_padrao"><a href="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8"><img src="http://<?php echo $url_player; ?>/img/icones/img-icone-player-iphone.png" width="32" height="32" border="0" /></a><br />
                <br />
                <textarea readonly="readonly" style="width:220px; height:100px;font-size:11px" onmouseover="this.select()"><a href="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8"><img src="http://<?php echo $url_player; ?>/img/icones/img-icone-player-iphone.png" width="32" height="32" title="Ouvir no iphone" /></a></textarea></td>
          </tr>
          <tr>
            <td align="center"><img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" /></td>
            <td align="center"><img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" /></td>
            <td align="center"><img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" /></td>
          </tr>
          <tr>
            <td align="center"><textarea readonly="readonly" style="width:220px; height:50px;font-size:11px" onmouseover="this.select()"><img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" title="Android" /></textarea></td>
            <td align="center"><textarea readonly="readonly" style="width:220px; height:50px;font-size:11px" onmouseover="this.select()"><img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" title="BlackBerry" /></textarea></td>
            <td align="center"><textarea readonly="readonly" style="width:220px; height:50px;font-size:11px" onmouseover="this.select()"><img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chl=http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $_POST["camera_stream"]; ?>/playlist.m3u8" title="IOS" /></textarea></td>
          </tr>
        </table>
						<?php } else { ?>
                        <?php echo $lang['lang_info_players_player_ip_camera_info']; ?>
