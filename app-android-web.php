...
if($_POST["acao_form"] == "criar") {
    ...
    die ("<script> alert(\"Nome da radio n�o pode iniciar com numeros.\\n\\nRadio name cant stat with number.\");
          window.location = 'javascript:history.back(-1)'; </script>");
    }
    */
  ...
  $source = "source-app-player";

  $hash = nome_app_play2($webtv_nome)."_".md5($webtv_nome);
  $package = "com.shoutcast.stm.".nome_app_play2($webtv_nome)."";
  ...
  replace2("".$patch_app."/app/src/main/res/values/strings.xml","URL_PLAYER","https://".$url_player."/player-app/".$dados_stm["login"]."");
  ...
  replace2("".$patch_app."/app/src/main/res/values/strings.xml","MSG_SHARE","Gostaria de compartilhar meu app favorito com voc�.");
  ...
  if(file_exists("/home/painelvideo/public_html/app/apps/".$hash."/arquivos_google_play/App-".$nome_apk.".apk") && file_exists("/home/painelvideo/public_html/app/apps/".$hash."/arquivos_google_play/App-".$nome_apk.".aab")) {
  ...
  if ($zip->open("/home/painelvideo/public_html/app/apps/".$hash.".zip", ZIPARCHIVE::CREATE)!==TRUE) {
      die("N�o foi poss�vel criar o arquivo ZIP: ".$hash.".zip");
  }
  ...
  $zip->addFile("/home/painelvideo/public_html/app/apps/".$hash."/arquivos_google_play/App-".$nome_apk.".aab","".$nome_apk."/App-".$nome_apk.".aab");
  ...
  header("Location: /app-android-web");
  exit();
...
$lang[ 'lang_info_streaming_app_android_info_configuracoes' ] = 'As demais configura��es do app, como site, redes sociais e outros ser�o configurados aqui ap�s criar o app.' ;
$lang[ 'lang_info_streaming_app_android_info_configuracoes2' ] = 'Ao alterar as configura��es abaixo, as mesams ser�o atualizadas automaticamente no app sem precisar criar um novo.' ;
...
$lang[ 'lang_info_streaming_app_android_tab_configurar_app' ] = 'Configurar App' ;
$lang[ 'lang_info_streaming_app_android_info_configuracoes' ] = 'Las otras configuraciones de la aplicaci�n, como sitio web, redes sociales y otras, se configurar�n aqu� despu�s de crear la aplicaci�n.' ;
$lang[ 'lang_info_streaming_app_android_info_configuracoes2' ] = 'Al cambiar la configuraci�n a continuaci�n, los datos se actualizar�n autom�ticamente en la aplicaci�n sin tener que crear uno nuevo.' ;
...
?>
  ...
  <form method="post" action="/app-android-web" style="padding:0px; margin:0px" enctype="multipart/form-data"> 
  ...
  <form method="post" action="/app-android-web" style="padding:0px; margin:0px" enctype="multipart/form-data">
    ...
    <tr>
      <td width="20%" height="50" class="texto_padrao_destaque">Tela Inicial</td>
      <td width="80%" class="texto_padrao_pequeno"><input name="app_tela_inicial" type="radio" value="1" <?php if($dados_stm["app_tela_inicial"] == 1) { echo ' checked="checked"'; } ?> />&nbsp;Logo + Bot&atilde;o Play&nbsp;<input name="app_tela_inicial" type="radio" value="2" <?php if($dados_stm["app_tela_inicial"] == 2) { echo ' checked="checked"'; } ?> />
      &nbsp;Player</td>
    </tr>
    <tr>
