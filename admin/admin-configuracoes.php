...
mysqli_query($conexao,"Update configuracoes set dominio_padrao = '".$_POST["dominio_padrao"]."', codigo_servidor_atual = '".$_POST["codigo_servidor_atual"]."', manutencao = '".$_POST["manutencao"]."'") or die(mysqli_error($conexao));
...
$_SESSION["status_acao"] .= status_acao("Erro: ".mysqli_error($conexao)."","erro");
...
$query = mysqli_query($conexao,"SELECT * FROM servidores WHERE status = 'on' ORDER by ordem ASC");
