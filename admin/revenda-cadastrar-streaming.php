    ...
    <div class="tab-pane" id="tabPane1">
      ...
      <tr>
        ...
        <td align="left" class="texto_padrao_destaque">
          ...
          <option value="webrtc">WebRTC(baixo delay)</option>
      ...
      <tr>
		...
		<?php
        $query_plano = mysqli_query($conexao,"SELECT * FROM revendas_planos where codigo_revenda = '".$dados_revenda["codigo"]."' AND tipo = 'streaming' ORDER by nome");
      ...
      <?php if($dados_revenda["srt_status"] == 'sim') { ?>
      <tr>
