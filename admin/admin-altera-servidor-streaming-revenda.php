...
$dados_servidor = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM servidores where codigo = '".$servidor."'"));
$dados_stm = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM streamings where login = '".$login."'"));
$dados_revenda = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM revendas WHERE codigo = '".$_POST["codigo_cliente"]."'"));

mysqli_query($conexao,"UPDATE streamings set codigo_servidor = '".$dados_servidor["codigo"]."' where login = '".$dados_stm["login"]."'");
