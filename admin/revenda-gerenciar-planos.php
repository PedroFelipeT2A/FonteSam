...
mysqli_query($conexao,"INSERT INTO revendas_planos (codigo_revenda,nome,espectadores,bitrate,espaco_ftp,ipcameras,subrevendas,streamings,tipo,aplicacao) VALUES ('".$dados_revenda["codigo"]."','".$_POST["nome"]."','".$_POST["espectadores"]."','".$_POST["bitrate"]."','".$_POST["espaco_ftp"]."','".$_POST["ipcameras"]."','".$_POST["subrevendas"]."','".$_POST["streamings"]."','".$_POST["tipo"]."','".$_POST["aplicacao"]."')");
...
<?php
$total_planos = mysqli_num_rows(mysqli_query($conexao,"SELECT * FROM revendas_planos where codigo_revenda = '".$dados_revenda["codigo"]."'"));

if($total_planos > 0) {

$sql = mysqli_query($conexao,"SELECT * FROM revendas_planos where codigo_revenda = '".$dados_revenda["codigo"]."' ORDER by nome");
while ($dados_plano = mysqli_fetch_array($sql)) {
