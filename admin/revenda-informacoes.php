...
$subrevendas_subrevendas = mysqli_fetch_array(mysqli_query($conexao,"SELECT SUM(subrevendas) as total FROM revendas WHERE codigo_revenda = '".$dados_revenda["codigo"]."'"));
...
carregar_avisos_revenda($conexao);
?></td>
          </tr>
        </table>
      </div>
