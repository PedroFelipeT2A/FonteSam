...
mysqli_query($conexao,"INSERT INTO avisos (codigo_servidor,area,titulo,descricao,data,mensagem,status) VALUES ('".$_POST["codigo_servidor"]."','".$_POST["area"]."','".$_POST["titulo"]."','".$_POST["descricao"]."',NOW(),'".nl2br($_POST["mensagem"])."','".$_POST["status"]."')") or die("Erro ao processar query.<br>Mensagem do servidor: ".mysqli_error($conexao));
$codigo_aviso = mysqli_insert_id($conexao);
