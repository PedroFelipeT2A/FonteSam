  ...
  <form method="post" action="/admin/admin-cadastra-servidor" style="padding:0px; margin:0px">
    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#F4F4F7; border:#CCCCCC 1px solid;">
      ...
      <tr>
        ...
        <td align="left"><input name="path_home" type="text" class="input" id="path_home" style="width:250px;" value="/home" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <option value="" selected="selected">Servidor Único</option>
            <?php
...
echo '<option value="' . strtolower($dados_servidor["nome"]) . '">' . $dados_servidor["nome"] . ' - ' . $dados_servidor["ip"] . '</option>';
