...
$query = "SELECT * FROM streamings where login = '".$_POST["chave"]."' AND codigo_cliente = '".$dados_revenda["codigo"]."'";

} elseif($_POST["local"] == 'espectadores') {

$query = "SELECT * FROM streamings where espectadores = '".$_POST["chave"]."' AND codigo_cliente = '".$dados_revenda["codigo"]."'";
...
$dados_servidor = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM servidores where ip = '".$_POST["chave"]."'"));

$query = "SELECT * FROM streamings where codigo_servidor = '".$dados_servidor["codigo"]."' AND codigo_cliente = '".$dados_revenda["codigo"]."'";

} elseif($_POST["local"] == 'servidor_nome') {

$dados_servidor = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM servidores where nome = '".$_POST["chave"]."'"));
...
<td height='25' align='left' scope='col' class='texto_padrao_pequeno'>&nbsp;".dominio_servidor($conexao,$dados_servidor["nome"])."</td>
