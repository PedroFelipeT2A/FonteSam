        ...
        <div class="texto_medio" id="quadro-conteudo">
            <table width="410" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" bgcolor="#FFFFFF" class="texto_padrao_pequeno"><?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?></td>
              </tr>
              <tr>
                ...
                <td align="left" bgcolor="#F8F8F8" class="texto_padrao_pequeno">rtmp://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $dados_stm["login"]; ?></td>
              </tr>
              <tr>
        ...
        <div class="texto_medio" id="quadro-conteudo">
            <table width="215" border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="110" align="left" bgcolor="#F8F8F8" class="texto_padrao_pequeno"><?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?></td>
              </tr>
              <tr>
