...
$dados_revenda = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM revendas WHERE codigo = '".code_decode(query_string('2'),"D")."'"));
?>
...
<?php
$sql_streamings = mysqli_query($conexao,"SELECT * FROM streamings where codigo_cliente = '".$dados_revenda["codigo"]."' ORDER by codigo_servidor ASC");
