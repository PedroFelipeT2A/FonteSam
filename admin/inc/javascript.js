...
function executar_acao_streaming_admin( codigo,acao ) {
	...
	} else if(acao == "manutencao-servidor") { window.open("/admin/admin-manutencao-servidor/"+codigo+""); } else if(acao == "configurar") {
...
function executar_acao_servidor( codigo,acao ) {
	...
	} else if(acao == "listar-conexoes") {
		window.location = "/admin/admin-servidor-conexoes/"+codigo+"";
	} else if(acao == "remover") {
...
function executar_acao_diversa( codigo,acao ) {
	...
	} else if(acao == "remover-plano") {
		remover_plano( codigo );
...
function configuracao_plano( configuracoes,tipo ) {
  ...
  document.getElementById("espectadores").value = array_configuracoes[2];
