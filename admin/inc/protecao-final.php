...
require("/home/painelvideo/public_html/admin/inc/conecta.php");

if($_SESSION["login_logado"]) {

$valida_usuario = mysqli_num_rows(mysqli_query($conexao,"SELECT * FROM streamings WHERE login = '".$_SESSION["login_logado"]."'"));
