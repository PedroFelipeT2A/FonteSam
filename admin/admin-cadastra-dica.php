...
mysqli_query($conexao,"INSERT INTO dicas_rapidas (titulo,mensagem,exibir) VALUES ('".$_POST["titulo"]."','".$_POST["mensagem"]."','".$_POST["exibir"]."')") or die("Erro ao processar query.<br>Mensagem do servidor: ".mysqli_error($conexao));
$codigo_fica = mysqli_insert_id($conexao);
