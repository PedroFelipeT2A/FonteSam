...
$dados_revenda_atual = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM revendas WHERE codigo = '".$_SESSION["code_user_logged"]."'"));
...
mysqli_query($conexao,"Update revendas set senha = PASSWORD('".$_POST["senha"]."'), url_suporte = '".$_POST["url_suporte"]."', dominio_padrao = '".$dominio_padrao."', stm_exibir_tutoriais = '".$_POST["stm_exibir_tutoriais"]."', url_tutoriais = '".$_POST["url_tutoriais"]."', stm_exibir_downloads = '".$_POST["stm_exibir_downloads"]."', idioma_painel = '".$_POST["idioma_painel"]."', stm_exibir_app_android = '".$_POST["stm_exibir_app_android"]."', stm_exibir_app_android_painel = '".$_POST["stm_exibir_app_android_painel"]."' where codigo = '".$_SESSION["code_user_logged"]."'") or die(mysqli_error($conexao));

} else {

mysqli_query($conexao,"Update revendas set url_suporte = '".$_POST["url_suporte"]."', dominio_padrao = '".$dominio_padrao."', stm_exibir_tutoriais = '".$_POST["stm_exibir_tutoriais"]."', url_tutoriais = '".$_POST["url_tutoriais"]."', stm_exibir_downloads = '".$_POST["stm_exibir_downloads"]."', idioma_painel = '".$_POST["idioma_painel"]."', stm_exibir_app_android = '".$_POST["stm_exibir_app_android"]."', stm_exibir_app_android_painel = '".$_POST["stm_exibir_app_android_painel"]."' where codigo = '".$_SESSION["code_user_logged"]."'") or die(mysqli_error($conexao));
...
mysqli_query($conexao,"Update streaming.streamings set exibir_app_android ='".$_POST["stm_exibir_app_android"]."' where codigo_cliente = '".$_SESSION["code_user_logged"]."'");
}

// Insere a ação executada no registro de logs.
logar_acao($conexao,"revenda","".$dados_revenda_atual["codigo"]."","Configurações da revenda alteradas com sucesso.");
