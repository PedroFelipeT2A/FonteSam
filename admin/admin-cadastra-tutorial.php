...
mysqli_query($conexao,"INSERT INTO tutoriais (titulo,data,tutorial) VALUES ('".$_POST["titulo"]."',NOW(),'".addslashes($tutorial)."')") or die("Erro ao processar query.<br>Mensagem do servidor: ".mysqli_error($conexao));

// Cria o sessão do status das ações executadas e redireciona.
$_SESSION["status_acao"] = status_acao("Tutorial ".$_POST["titulo"]." cadastrado com sucesso.","ok");
