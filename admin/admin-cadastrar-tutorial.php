...
tinyMCE.init({
  ...
  <form method="post" action="/admin/admin-cadastra-tutorial" style="padding:0px; margin:0px">
    <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="background-color:#F4F4F7; border:#CCCCCC 1px solid;">
      <tr>
        <td width="105" height="35" align="left" class="texto_padrao_destaque" style="padding-left:5px;">Titulo</td>
        <td width="593" align="left"><input name="titulo" type="text" class="input" id="titulo" style="width:570px;" /></td>
      </tr>
      <tr>
        <td height="30" colspan="2"><textarea id="tutorial" name="tutorial" rows="30" style="width:100%"></textarea></td>
      </tr>
      <tr>
