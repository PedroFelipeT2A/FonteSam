...
mysqli_query($conexao,"Update tutoriais set titulo = '".$_POST["titulo"]."', tutorial = '".addslashes($tutorial)."' where codigo = '".$_POST["codigo"]."'") or die("Erro ao processar query.<br>Mensagem do servidor: ".mysqli_error($conexao));
