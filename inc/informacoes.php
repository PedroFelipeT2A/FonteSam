...
$dados_playlist_atual = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM playlists WHERE  codigo = '".$dados_stm["ultima_playlist"]."'"));
...
<table width="885" border="0" cellpadding="0" cellspacing="0" align="center">
            		...
            		<div class="texto_medio" id="quadro-conteudo">
            		  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="display:block" id="tabela_avisos">
                        <tr>
						  ...
						  <?php
							carregar_avisos_streaming($conexao,$dados_stm["porta"],$dados_servidor["codigo"]);
						  ?>						  </td>
                        </tr>
                      </table>
            		</div>
  ...
  <table width="885" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:10px">
    <tr>
      <td width="315" height="50" align="center" valign="top" style="padding-right:5px"><div id="quadro">
        ...
        <div class="texto_medio" id="quadro-conteudo">
            <table width="295" border="0" cellpadding="0" cellspacing="0" style="display:block" id="tabela_info_stm">
              <tr>
                <td width="100" height="25" align="left" bgcolor="#F8F8F8" class="texto_padrao_destaque">&nbsp;<?php echo $lang['lang_info_porta']; ?></td>
                <td align="left" bgcolor="#F8F8F8" class="texto_padrao"><?php echo $dados_stm["porta"]; ?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td align="left" bgcolor="#F8F8F8" class="texto_padrao_pequeno"><?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?></td>
              </tr>
              <?php if($dados_stm["tipo_servidor"] == "icecast") { ?>
              <tr>
                <td height="25" align="left" bgcolor="#F8F8F8" class="texto_padrao_destaque"><span class="label label-amarelo">IceCast SSL</span></td>
                <td align="left" class="texto_padrao_pequeno"><span class="label label-verde">https://<?php echo $dados_servidor["nome"]; ?>.<?php echo $dados_config["dominio_padrao"]; ?>:<?php echo $dados_stm["porta"]; ?></span></td>
              </tr>
                <tr>
                <td height="25" align="left" class="texto_padrao_destaque">Tipo Streaming</td>
                <td align="left" class="texto_padrao">IceCast 2.4.4</td>
              </tr>
            <?php } else { ?>
              <tr>
                <td height="25" align="left" class="texto_padrao_destaque">&nbsp;<?php echo $lang['lang_info_shoutcast']; ?></td>
                <td align="left" class="texto_padrao_pequeno"><a href="javascript:abrir_janela('https://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>:<?php echo $dados_stm["porta"]; ?>',720,500);">https://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>:<?php echo $dados_stm["porta"]; ?></a></td>
              </tr>
              <tr>
                <td height="25" align="left" bgcolor="#F8F8F8" class="texto_padrao_destaque"><span class="label label-amarelo">ShoutCast SSL</span></td>
                <td align="left" bgcolor="#F8F8F8" class="texto_padrao"><span class="label label-verde">https://<?php echo $dados_servidor["nome"]; ?>.<?php echo $dados_config["dominio_padrao"]; ?>:<?php echo $dados_stm["porta"]; ?></span></td>
              </tr>
                <tr>
                <td height="25" align="left" class="texto_padrao_destaque">Tipo Streaming</td>
                <td align="left" class="texto_padrao">ShoutCast 2.6.1</td>
              </tr>
            <?php } ?>
            </table>
        </div>
      </div></td>
    <td width="285" align="center" valign="top" style="padding-left:5px; padding-right:5px"><div id="quadro">
        ...
        <div class="texto_medio" id="quadro-conteudo">
            <table width="265" border="0" cellpadding="0" cellspacing="0" style="display:block" id="tabela_info_plano">
              <tr>
              ...
              <tr>
                ...
                <tr>
                <td height="25" align="left" bgcolor="#F8F8F8" class="texto_padrao_destaque">&nbsp;Playlist Atual</td>
                <td align="left" bgcolor="#F8F8F8" class="texto_padrao"><?php echo $dados_playlist_atual["nome"]; ?></td>
              </tr>
    ...
    <td width="285" align="center" valign="top" style="padding-left:5px;"><div id="quadro">
        ...
        <div class="texto_medio" id="quadro-conteudo">
            <table width="265" border="0" cellpadding="0" cellspacing="0" style="display:block" id="tabela_info_ftp">
              <tr>
              ...
              <tr>
                <td height="25" align="left" class="texto_padrao_destaque">&nbsp;<?php echo $lang['lang_info_porta']; ?></td>
                <td align="left" class="texto_padrao">21 (FTP)</td>
              </tr>
              <tr>
            ...
            <div class="texto_medio" id="quadro-conteudo">
                <table width="425" border="0" align="center" cellpadding="0" cellspacing="0" style="display:block" id="tabela_gerenciamento_streaming">
                  <tr>
                    ...
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/configuracoes-streaming','conteudo');"><img src="img/icones/img-icone-configuracoes.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_config']; ?>" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_config']; ?></td>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/configuracoes-relay','conteudo');"><img src="img/icones/img-icone-relay.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_config_relay']; ?>" width="48" height="48" /> <br />
                  ...
                  <tr>
                    ...
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/estatisticas','conteudo');"><img src="img/icones/img-icone-estatistica.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_stats']; ?>" width="48" height="48" /> <br />
                  ...
                  <tr>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/logs-shoutcast','conteudo');"><img src="img/icones/img-icone-logs-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_logs_servidor']; ?>" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_logs_servidor']; ?></td>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/app-android','conteudo');"><img src="img/icones/img-icone-app-android-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_app_android']; ?> Web" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_app_android']; ?>&nbsp;</td>
                    <td width="141" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-musicas-gratis','conteudo');"><img src="img/icones/img-icone-tag-mp3-64x64.png" title="Musicas Gratis" width="48" height="48" /> <br />Musicas Gratis&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                  </tr>
                  
                  <tr>
                  <?php if($dados_stm["camera_studio"] == 'sim') { ?>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/camera-studio','conteudo');"><img src="img/icones/img-icone-webcam-48x48.png" alt="C&acirc;mera Studio" width="48" height="48" /> <br />
                      C&acirc;mera Studio&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                  <?php } ?>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-player-moderno','conteudo');"><img src="img/icones/img-icone-player-moderno.png" alt="Player Moderno" width="48" height="48" /> <br />
                      Player Moderno&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                      <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/pedidos','conteudo');"><img src="img/icones/img-icone-pedidos-musicas-64x64.png" title="Pedidos" width="48" height="48" /> <br />
                        Pedidos M&uacute;sicais&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                  </tr>
                  <tr>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/app-multi-plataforma','conteudo');"><img src="img/icones/img-icone-app-multi-plataforma.png" width="48" height="48" /> <br />
                      App Multi Plataforma&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                    
                      <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/chat','conteudo');"><img src="img/icones/img-icone-chat-64x64.png" alt="Player Moderno" width="48" height="48" /> <br />
                        Chat&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                      <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-lives','conteudo');"><img src="img/icones/img-icone-lives.png" title="Lives" width="48" height="48" /><br />
                        Lives&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                  </tr>
                </table>
            </div>
          </div></td>
            ...
            <div class="texto_medio" id="quadro-conteudo">
                <table width="425" border="0" align="center" cellpadding="0" cellspacing="0" style="display:block" id="tabela_gerenciamento_autodj">
                  <tr>
                    ...
                    <td width="143" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="trocar_playlist('<?php echo $porta_code;?>','carregar_playlists','0');"><img src="img/icones/img-icone-trocar-playlist.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_trocar_playlist']; ?>" width="48" height="48" /> <br />
                  ...
                  <tr>
                    ...
                    <td width="143" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-djs','conteudo');"><img src="img/icones/img-icone-dj.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_gerenciar_djs']; ?>" width="48" height="48" /> <br />
                  ...
                  <tr>
                    ...
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-agendamentos-relay','conteudo');"><img src="img/icones/img-icone-agendamento.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_gerenciar_agendamentos_relay']; ?> Relay" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_gerenciar_agendamentos_relay']; ?></td>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-playlists-hora-certa','conteudo');"><img src="img/icones/img-icone-hora-certa-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_hora_certa']; ?>" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_hora_certa']; ?></td>
                  </tr>
                  <tr>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-playlists-vinhetas-comerciais','conteudo');"><img src="img/icones/img-icone-vinhetas-comerciais-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_vinhetas_comerciais']; ?>" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_vinhetas_comerciais']; ?></td>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/configuracoes-autodj','conteudo');"><img src="img/icones/img-icone-configuracoes.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_config']; ?>" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_config']; ?></td>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/logs-autodj','conteudo');"><img src="img/icones/img-icone-logs-64x64.png" alt="" width="48" height="48" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_logs_servidor']; ?>" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_logs_servidor']; ?></td>
                  </tr>
		<tr>
                    <td width="141" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-playlists-programetes','conteudo');"><img src="img/icones/img-icone-programetes-programas-64x64.png" title="Programetes" width="48" height="48" /> <br />Programetes&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                    <td width="141" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-playlists-programas','conteudo');"><img src="img/icones/img-icone-programetes-programas-64x64.png" title="Programas" width="48" height="48" /> <br />Programas&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/download-programas-programetes','conteudo');"><img src="img/icones/img-icone-download-pp-48x48.png" title="Downlod Conteudos" width="48" height="48" /> <br />
                      Download Conte&uacute;dos&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
		</tr>
		<tr>
 		    <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/gerenciar-acoes-autodj','conteudo');"><img src="img/icones/img-icone-agendamento2.png" title="Ações AutoDJ" width="48" height="48" /><br />Ações AutoDJ&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                   
                    <td width="143" height="80" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="window.open('/webftp','conteudo');"><img src="img/icones/img-icone-web-ftp-64x64.png" title="WEBFTP" width="48" height="48"> <br>
                        WEBFTP&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                        <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/autodj-disparar-conteudo','conteudo');"><img src="/img/icones/img-icone-disparar-conteudo.png" width="48" height="48" /> <br />
                      Disparar Conte&uacute;do&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
		</tr>
		</table>
            </div>
          </div></td>
                ...
                <table width="870" border="0" align="center" cellpadding="0" cellspacing="0" style="display:block" id="tabela_gerenciamento_streaming">
                  ...
                  <tr>
                    ...
                    <td width="145" height="80" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/logs-shoutcast','conteudo');"><img src="img/icones/img-icone-logs-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_logs_servidor']; ?>" width="48" height="48" /> <br />
                        <?php echo $lang['lang_info_pagina_informacoes_tab_menu_logs_servidor']; ?></td>
                        <td height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/app-android','conteudo');"><img src="img/icones/img-icone-app-android-web.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_app_android']; ?> Web" width="48" height="48" /> <br />
      ...
      <div id="quadro">
        ...
        <div class="texto_medio" id="quadro-conteudo">
          <table width="875" border="0" align="center" cellpadding="0" cellspacing="0" style="display:block" id="tabela_utilitarios">
            <tr>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="definir_nome_musica('<?php echo $porta_code;?>','<?php echo $lang['lang_info_pagina_informacoes_tab_menu_definir_nome_musica_info']; ?>');"><img src="img/icones/img-icone-mudar-nome-musica-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_definir_nome_musica']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_definir_nome_musica']; ?></td>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-gravador','conteudo');"><img src="img/icones/img-icone-gravar-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_gravador']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_gravador']; ?></td>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-migrar-musicas','conteudo');"><img src="img/icones/img-icone-download-musica-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_migrar_musicas']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_migrar_musicas']; ?>&nbsp;</td>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-editar-tag-musicas','conteudo');"><img src="img/icones/img-icone-tag-mp3-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_editar_tag_musicas']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_editar_tag_musicas']; ?>&nbsp;</td>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-download-mp3','conteudo');"><img src="img/icones/img-icone-download-mp3.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_download_mp3']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_download_mp3']; ?></td>
              </tr>
            <tr>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-download-soundcloud','conteudo');"><img src="img/icones/img-icone-download-soundcloud.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_download_soundcloud']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_download_soundcloud']; ?></td>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-youtube','conteudo');"><img src="img/icones/img-icone-youtube-64x64.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_download_youtube']; ?>" width="48" height="48" /> <br />
                  <?php echo $lang['lang_info_pagina_informacoes_tab_menu_download_youtube']; ?></td>
              <?php if($dados_stm["autodj"] == 'sim') { ?>
             <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-ferramentas-mp3','conteudo');"><img src="img/icones/img-icone-editor-mp3.png" title="Ferramentas MP3" width="48" height="48" /><br />
               Ferramentas MP3&nbsp;<span class="label label-verde"><?php echo $lang['lang_label_novo']; ?></span></td>
                <?php } ?>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-editar-tag-musicas','conteudo');">&nbsp;</td>
              <td width="175" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/utilitario-download-mp3','conteudo');">&nbsp;</td>
              </tr>
          </table>
        </div>
      </div></td>
      ...
      <td width="885" height="50" align="center" valign="top"><div id="quadro">
        ...
        <div class="texto_medio" id="quadro-conteudo">
            <table width="875" border="0" align="center" cellpadding="0" cellspacing="0" style="display:block" id="tabela_painel">
              <tr>
                <td width="125" height="75" align="center" class="texto_padrao_destaque" style="cursor:pointer" onclick="abrir_log_sistema();window.open('/configuracoes-painel','conteudo');"><img src="img/icones/img-icone-configuracoes.png" title="<?php echo $lang['lang_info_pagina_informacoes_tab_menu_config_painel']; ?>" width="48" height="48" /> <br />
