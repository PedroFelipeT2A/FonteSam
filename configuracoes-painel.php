...
// Cria o sessão do status das ações executadas e redireciona.
$_SESSION["status_acao"] = status_acao("".$lang['lang_info_config_painel_resultado_erro']." ".mysqli_error($conexao)."","erro");
              ...
              <table width="540" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="215" align="center" scope="col">
                    ...
                    <?php
					$sql_atalhos = mysqli_query($conexao,"SELECT * FROM atalhos where codigo_stm = '".$dados_stm["codigo"]."' ORDER by ordem ASC");
					while ($dados_atalhos = mysqli_fetch_array($sql_atalhos)) {
