...
$url_source_http = "https://".dominio_servidor($conexao,$dados_servidor["nome"])."/".$dados_stm["login"]."/".$dados_stm["login"]."/playlist.m3u8";
...
<script type="text/javascript" src="movel/inc/originais/ajax-streaming.js"></script>
