...
$dados_tutorial = mysqli_fetch_array(mysqli_query($conexao,"SELECT * FROM tutoriais where codigo = '".$tutorial_code."'"));
...
$tutorial = str_replace("[SERVIDOR]",dominio_servidor($conexao,$dados_servidor["nome"]),$dados_tutorial["tutorial"]);
$tutorial = str_replace("[LOGIN]",$dados_stm["login"],$tutorial);
$tutorial = str_replace("[PAINEL]",$_SERVER['HTTP_HOST'],$tutorial);

mysqli_query($conexao,"UPDATE tutoriais SET vizualizacoes = vizualizacoes+1 WHERE codigo = '".$dados_tutorial["codigo"]."'");
...
<div class="texto_medio" id="quadro-conteudo">
  ...
  <tr>
	...
	<br />
<?php
$sql = mysqli_query($conexao,"SELECT * FROM tutoriais WHERE codigo != '".$dados_tutorial["codigo"]."' ORDER by vizualizacoes DESC LIMIT 5");
