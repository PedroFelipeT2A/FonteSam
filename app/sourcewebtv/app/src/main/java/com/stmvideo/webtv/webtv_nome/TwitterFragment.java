...
public class TwitterFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(R.string.menu_twit));
        ...
        JsonUtils.setStatusBarGradiant(TwitterFragment.this);
    ...
    private void loadUrl() {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode,
                ...
                Toast.makeText(TwitterFragment.this, description, Toast.LENGTH_SHORT)
                        .show();
            }
        });
