...
<div class="texto_medio" id="quadro-conteudo">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
						  ...
						  <td align="left" bgcolor="#F8F8F8" class="texto_padrao"><?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?></td>
   						</tr>
					  </table>
		  </div>
      </div>
    ...
    <div id="quadro">
       <div id="quadro-topo"><strong>Player</strong></div>
        ...
        <video id="my-video" class="video-js" controls preload="auto" width="300" height="220" data-setup="">
           <source src="rtmp://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $dados_stm["login"]; ?>" type="rtmp/mp4">
           <source src="http://<?php echo dominio_servidor($conexao,$dados_servidor["nome"]); ?>/<?php echo $dados_stm["login"]; ?>/<?php echo $dados_stm["login"]; ?>/playlist.m3u8" type="application/x-mpegURL">
