...
$total_agendamentos = mysqli_num_rows(mysqli_query($conexao,"SELECT * FROM playlists_agendamentos where codigo_playlist = '".$dados_playlist["codigo"]."'"));
...
<td height='25' align='left' scope='col' class='texto_padrao'>&nbsp;".sprintf('%02d:%02d:%02d', ($duracao["total"]/3600),($duracao["total"]/60%60), $duracao["total"]%60)."</td>
