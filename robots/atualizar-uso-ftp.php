...
$sql = mysqli_query($conexao,"SELECT * FROM streamings where status = '1' ORDER by codigo ASC");
...
mysqli_query($conexao,"Update streamings set espaco_usado = '".$resultado."' where codigo = '".$dados_stm["codigo"]."'");
