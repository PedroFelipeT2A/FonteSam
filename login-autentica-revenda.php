...
$valida_usuario = mysqli_num_rows(mysqli_query($conexao,"SELECT * FROM streamings WHERE (login = '".anti_sql_injection($login_X)."' AND senha = '".anti_sql_injection($senha_Y)."') AND codigo_cliente = '".$_SESSION["code_user_logged"]."'"));
